...
# ======================
# DATABASE FUNCTIONS - UPDATED FOR JOURNAL MANAGEMENT
# ======================
                    ...
                    if files:
                        ...
                        for file in files:
                            with st.expander(f"{file['name']} ({file['entry_count']} entries)"):
                                ...
                                with col3:
                                    if st.button("✏️ Rename", key=f"rename_{file['name']}"):
                                ...
                                if st.button("➡️ Move to Another Journal", key=f"move_{file['name']}"):
